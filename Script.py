...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """
<b>🗞️ Fɪʟᴇ ɴᴀᴍᴇ : </b> <code>{file_name}</code>

<b>
╭─────── • ◆ • ───────╮
 📺 Oᴜʀ Gʀᴏᴜᴘ:  <a href="https://t.me/Dcenimaunverse">Tᴏᴜᴄʜ</a>
╰─────── • ◆ • ───────╯

=========== • ✠ • ===========
▫️ ᴄʜᴀɴɴᴇʟ : @DCENIMAS
▫️ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : @DCENIMAS_HD
=========== • ✠ • ===========</b>"""

    IMDB_TEMPLATE_TXT = """
<b>  {title}

⭐️{rating} | ⏰ {runtime}  | 📆  {release_date}

● {genres}

● {languages}

📖 sᴛᴏʀʏ : </b> <code>  {plot}  </code>"""
    ALL_FILTERS = """
